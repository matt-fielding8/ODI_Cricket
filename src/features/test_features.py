...
url = "https://www.espncricinfo.com/series/19064/scorecard/1168515/ireland-vs-afghanistan-1st-odi-afg-in-ireland-2019"
g = Gather()
soup1 = g.getSoup(url)
...
df = pd.DataFrame(data=score_dct, columns=['match_id', 'team', 'score', 'detailed_score'])
print(df)